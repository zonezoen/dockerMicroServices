...
PostServiceClient.prototype.addPost = function(post, callback) {
...
PostServiceClient.prototype.send_addPost = function(post) {
...
PostServiceProcessor.prototype.process_addPost = function(seqid, input, output) {
  ...
  if (this._handler.addPost.length === 1) {
    Q.fcall(this._handler.addPost.bind(this._handler), args.post)
